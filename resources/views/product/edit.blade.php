                    ...
                    <div class="card-body">
                        <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('tag') is-invalid @enderror" name="tag" value="{{ old('tag', $product->name) }}" placeholder="Masukkan Judul Product">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('Category') is-invalid @enderror" name="category" value="{{ old('category', $product->name) }}" placeholder="Masukkan Category">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" class="form-control @error('stocks') is-invalid @enderror" name="stocks" value="{{ old('stocks', $product->stocks) }}" placeholder="Masukkan Stock Product">
                                    
                                        <!-- error message untuk stocks -->
                                        @error('stocks')
                                            <div class="alert alert-danger mt-2">
                                                {{ $message }}
                                            </div>
